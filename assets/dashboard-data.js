...
const MOCK_DATA = {
  ...
  topWorks: [
    { title: '《竹子》',              author: '示例作者A', school: '杨行中心校',        likes: 1284, comments: 312 },
    { title: '《AI绘梦 诗意节气》',   author: '示例作者B', school: '上海大学附属学校',  likes: 1156, comments: 268 },
    { title: '《大寒·立春》',         author: '示例作者C', school: '宝山区实验小学',    likes: 982,  comments: 197 },
    { title: '《记录我的研究与成长》', author: '示例作者D', school: '经纬实验小学',      likes: 864,  comments: 156 },
    { title: '《青竹问雪》',          author: '示例作者E', school: '第一中心小学',      likes: 731,  comments: 143 }
  ],
  schoolRank: [
  ...
  feed: [
    { kind: 'like',    user: '示例用户A', work: '《竹子》',            note: '',                 time: '刚刚' },
    ...
    { kind: 'like',    user: '示例作者E', work: '《青竹问雪》',         note: '',                 time: '4分钟前' },
