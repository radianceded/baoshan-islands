...
const NUTRITION_SESSION_TOKEN = sessionStorage.getItem('bs_session_token') || '';
if (location.protocol !== 'file:' && !NUTRITION_SESSION_TOKEN) {
  location.replace('/login.html?campus=benbu');
}
const NUTRITION_ROLE = sessionStorage.getItem('bs_role') || NUTRITION_CONTEXT.get('role') || 'none';
const NUTRITION_CHILD_CODE = sessionStorage.getItem('bs_bound_id_card') || NUTRITION_CONTEXT.get('childCode') || '';
const NUTRITION_SUB_ROLE = sessionStorage.getItem('bs_sub_role') || NUTRITION_CONTEXT.get('subRole') || '';
const NUTRITION_GRADE = sessionStorage.getItem('bs_bound_grade') || NUTRITION_CONTEXT.get('grade') || '';
const NUTRITION_CLASS = sessionStorage.getItem('bs_bound_class') || NUTRITION_CONTEXT.get('class') || '';
